...
use Swoolefy\Http\Interfaces\HeadersInterface;
...
class Request extends Message implements ServerRequestInterface
{
     ...
     * @throws \Exception on invalid HTTP method
     */
    ...
    protected function filterMethod($method)
    {
        ...
        if (preg_match("/^[!#$%&'*+.^_`|~0-9a-z-]+$/i", $method) !== 1) {
            throw new \Exception(sprintf('Unsupported HTTP method "%s" provided', $method));
        }
